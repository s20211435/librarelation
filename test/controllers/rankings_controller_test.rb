...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { author_name: @ranking.author_name, book_rank: @ranking.book_rank, isbn_number: @ranking.isbn_number, title: @ranking.title } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { author_name: @ranking.author_name, book_rank: @ranking.book_rank, isbn_number: @ranking.isbn_number, title: @ranking.title } }
